...
export const metadata: Metadata = {
  title: "The Library Wine Boutique Madrid | Boutique, Bar y Club Privado",
  description: "Homenaje al vino y a aquellos que lo saben disfrutar. The Library combina una exclusiva Boutique, un Bar Gastronómico y Club Privado en el corazón de Madrid.",
  keywords: "wine boutique Madrid, club privado vinos, bar gastronómico, vinos exclusivos, sommelier Madrid, catas privadas",
  metadataBase: new URL("https://thelibraryboutique.com/"),
  alternates: {
    canonical: "https://thelibraryboutique.com/"
  },
  openGraph: {
    title: "The Library Wine Boutique Madrid",
    description: "Triple concepto exclusivo: Boutique, Bar Gastronómico y Club Privado. Más de 3.500 referencias de vinos en el corazón de Madrid.",
    siteName: "The Library Wine Boutique",
    url: "https://thelibraryboutique.com/",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763212586839-yy5npkto.jpg",
      alt: "The Library Wine Boutique Madrid interior"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "The Library Wine Boutique Madrid",
    description: "Homenaje al vino y a aquellos que lo saben disfrutar. Boutique, Bar Gastronómico y Club Privado.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763212586839-yy5npkto.jpg"]
  },
  robots: {
    index: true,
    follow: true
